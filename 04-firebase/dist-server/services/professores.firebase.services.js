...
var ProfessoresFirebaseServices = /*#__PURE__*/function () {
  ...
  _createClass(ProfessoresFirebaseServices, null, [{
      ...
      var _register = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              (0, _firestore.addDoc)((0, _firestore.collection)(_firebase["default"], 'professores'), req.body).then(function (docRef) {
    ...
    value: function update(req, res) {
      var ref = (0, _firestore.doc)(_firebase["default"], 'professores', req.params.id);
      (0, _firestore.updateDoc)(ref, req.body).then(function () {
        return res.status(200).json({
          _id: req.params.id
        });
      });
    ...
    value: function _delete(req, res) {
      var ref = (0, _firestore.doc)(_firebase["default"], 'professores', req.params.id);
      (0, _firestore.deleteDoc)(ref);
    }
  }, {
    key: "retrieve",
    value: function retrieve(req, res) {
      var ref = (0, _firestore.doc)(_firebase["default"], 'professores', req.params.id);
      (0, _firestore.getDoc)(ref).then(function (docSnap) {
        var professor = _objectSpread({
          _id: docSnap.id
        }, docSnap.data());
    ...
    key: "listOnSnapshot",
    value: function listOnSnapshot(req, res) {
      var q = (0, _firestore.query)((0, _firestore.collection)(_firebase["default"], 'professores'));
